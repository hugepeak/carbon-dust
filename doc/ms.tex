...
$(t/t(6000 {\rm K}))^{-3}$.
Tight agreement for $T > 3500$ K is immediately evident,
demonstrating that for $T > 3500$ K the abundance of CO is almost exactly in
thermal equilibrium. Below 3500 K the abundance of CO becomes much less than
...
its maximum until expansion has cooled to $T=3500$ K.
...
Gathering factors yields approximately $4 \times 10^{-35} {atoms}^{-1}
{\rm s}^{-1}$ ({\bf UNITS??????}),
...
which is about 50\% of the temperature
...
thermal photodissociation. The similarity of Fig. \ref{fig:no_gamma}
to their Fig.11,
...
to $10^{-2}$ near 5500 K and the ratio $Y(CO)/Y(CO)$ near $10^4$ are
